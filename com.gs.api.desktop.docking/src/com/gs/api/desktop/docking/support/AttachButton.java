 ...
 * @since 1.0
 */
public class AttachButton extends javax.swing.JButton {
    ...
    public AttachButton (javax.swing.JTabbedPane tabbedPane, 
    ...
    private void initComponents() {
        ...
        setToolTipText("Dock this window to a tab");
        ...
        setIcon(new ImageIcon(getClass().getResource("/com/gs/api/desktop/"
                + "docking/resources/view-restore.png")));
