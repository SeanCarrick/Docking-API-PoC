 ...
 * @since 1.0
 */
public class DockedTabTitle extends javax.swing.JPanel {
    
    private final javax.swing.JTabbedPane tabbedPane;
    private final Dockable contentPane;
    
    public DockedTabTitle (javax.swing.JTabbedPane tabbedPane, Dockable contentPane) {
    ...
    private void initComponents() {
        ...
        JLabel label = new JLabel() {
            public String getText() {
                int i = tabbedPane.indexOfTabComponent(DockedTabTitle.this);
                if (i != -1) {
        ...
        //tab button
        JButton detatchButton = new DetatchButton(tabbedPane, contentPane);
        add(detatchButton);
